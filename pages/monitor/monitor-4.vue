<template>
	<view>
		...
		<view class="app-2">
			<text>简明扼要地写明具体、明确的要求</text>
			<view class="app-from">
				<view class="app-item">
					<text>请求事项</text>
					<view class=""><input v-model="fromData.content" placeholder="请输入请求事项（必填）" placeholder-class="plac-input" type="text" /></view>
				</view>
			</view>
			<text style="padding-top: 100upx;display: block;">简明扼要地写明事实原由</text>
			<view class="app-from">
				<view class="app-item">
					<text>请求事项</text>
					<view class=""><input v-model="fromData.brief" placeholder="请输入事实原由（必填）" placeholder-class="plac-input" type="text" /></view>
				</view>
			</view>
