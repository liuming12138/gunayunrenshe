	...
	<view>
		...
		<view class="app-2">
			...
			<view class="app-from">
				...
				<view class="app-item">
					<text>职务</text>
					<view class=""><input v-model="fromData.job" placeholder="请输入法定代表人职务名称（必填）" placeholder-class="plac-input" type="text" /></view>
				</view>
				<view class="app-item">
					<text>联系方式</text>
					<view class=""><input v-model="fromData.phone" placeholder="请输入法定代表人联系方式（必填）" placeholder-class="plac-input" type="text" /></view>
				</view>
				<view class="app-item">
					<text>注册地址</text>
				...
				<view class="app-item">
					<text>经营地址</text>
					<view class=""><input v-model="fromData.serviceAddress" placeholder="请输入企业经营地址（必填）" placeholder-class="plac-input" type="text" /></view>
				</view>
			</view>
